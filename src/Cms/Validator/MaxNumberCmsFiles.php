...
/**
 * Walidator - maksymalna liczba plików w Cms (musi być conajwyżej tyle ile podano)
 *
 ...
 */
class MaxNumberCmsFiles extends ValidatorAbstract
{
    /**
     * Komunikat błędnego kodu zabezpieczającego
     */
    public const INVALID = 'validator.maxNumberCmsFiles.message';
    ...
    /**
     * Waliduje czy w cms_file nie znajduje się za duża liczba plików dla danego rekordu
     * @param mixed $value
     * @return boolean
     */
