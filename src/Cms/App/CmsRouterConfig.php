...
class CmsRouterConfig extends RouterConfig
{
    ...
    public function __construct()
    {
        ...
        $this->setRoute('cms-category-scopes-api', '/^api\/([a-z0-9-]+)\/contents$/', ['module' => 'cms', 'controller' => 'api', 'action' => 'getMenu', 'scope' => '$1']);

        //routa API podglądu nieopublikownych stron cms
        $this->setRoute('cms-category-preview-api', '/^api\/([a-z0-9-]+)\/contents\/preview\/([0-9]+)\/([0-9]+)\/([0-9]+)$/', ['module' => 'cms', 'controller' => 'api', 'action' => 'getCategoryPreview', 'scope' => '$1', 'id' => '$2', 'originalId' => '$3', 'authId' => '$4']);
