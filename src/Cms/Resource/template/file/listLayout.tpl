{foreach $files as $file}
	<li>
		...
		{if $file['class']=="audio"}<a class="edit b_audio ico i_play" data-id="{$file['id']}" href="#odtworz"></a><div class="thumbbox audio"><audio src="{$file['full']}"></audio></div>{/if}
		{if $file['class']=="video"}<a class="edit b_video ico i_play" data-id="{$file['id']}" href="#odtworz"></a><div class="thumbbox video"><video src="{$file['full']}" ></video></div>{/if}
	</li>	
{/foreach}