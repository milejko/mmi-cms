{foreach $files as $file}
    <li>
        <a class="insert ui-icon ui-icon-circle-plus" {if $file['class']=="video"}data-poster="{thumbBinary($file['poster'], 'scalecrop', '854x480')}"{/if} data-typ="{$file['class']}" href="{$file['full']}" title="dodaj"></a>
