 ...
 * @method QueryHelper\CmsFileQueryField whereCmsFileOriginalId()
 * @method QueryHelper\CmsFileQueryField andFieldCmsFileOriginalId()
 * @method QueryHelper\CmsFileQueryField orFieldCmsFileOriginalId()
 * @method CmsFileQuery orderAscCmsFileOriginalId()
 * @method CmsFileQuery orderDescCmsFileOriginalId()
 * @method CmsFileQuery groupByCmsFileOriginalId()
 * @method QueryHelper\CmsFileQueryField whereNewUploaded()
 * @method QueryHelper\CmsFileQueryField andFieldNewUploaded()
 * @method QueryHelper\CmsFileQueryField orFieldNewUploaded()
 * @method CmsFileQuery orderAscNewUploaded()
 * @method CmsFileQuery orderDescNewUploaded()
 * @method CmsFileQuery groupByNewUploaded()
