 ...
 * @method QueryHelper\CmsAttributeTypeQueryField whereRestricted()
 * @method QueryHelper\CmsAttributeTypeQueryField andFieldRestricted()
 * @method QueryHelper\CmsAttributeTypeQueryField orFieldRestricted()
 * @method CmsAttributeTypeQuery orderAscRestricted()
 * @method CmsAttributeTypeQuery orderDescRestricted()
 * @method CmsAttributeTypeQuery groupByRestricted()
 * @method QueryHelper\CmsAttributeTypeQueryField whereMultiple()
 * @method QueryHelper\CmsAttributeTypeQueryField andFieldMultiple()
 * @method QueryHelper\CmsAttributeTypeQueryField orFieldMultiple()
 * @method CmsAttributeTypeQuery orderAscMultiple()
 * @method CmsAttributeTypeQuery orderDescMultiple()
 * @method CmsAttributeTypeQuery groupByMultiple()
 * @method QueryHelper\CmsAttributeTypeQueryField whereUploader()
 * @method QueryHelper\CmsAttributeTypeQueryField andFieldUploader()
 * @method QueryHelper\CmsAttributeTypeQueryField orFieldUploader()
 * @method CmsAttributeTypeQuery orderAscUploader()
 * @method CmsAttributeTypeQuery orderDescUploader()
 * @method CmsAttributeTypeQuery groupByUploader()
