 ...
 * @method QueryHelper\CmsAclQueryJoin join($tableName, $targetTableName = null, $alias = null)
 * @method QueryHelper\CmsAclQueryJoin joinLeft($tableName, $targetTableName = null, $alias = null)
