 ...
 * @method QueryHelper\CmsMailDefinitionQueryJoin join($tableName, $targetTableName = null, $alias = null)
 * @method QueryHelper\CmsMailDefinitionQueryJoin joinLeft($tableName, $targetTableName = null, $alias = null)
