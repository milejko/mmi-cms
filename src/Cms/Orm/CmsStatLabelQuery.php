 ...
 * @method QueryHelper\CmsStatLabelQueryJoin join($tableName, $targetTableName = null, $alias = null)
 * @method QueryHelper\CmsStatLabelQueryJoin joinLeft($tableName, $targetTableName = null, $alias = null)
