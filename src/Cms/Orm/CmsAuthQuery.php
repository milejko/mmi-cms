 ...
 * @method QueryHelper\CmsAuthQueryJoin join($tableName, $targetTableName = null, $alias = null)
 * @method QueryHelper\CmsAuthQueryJoin joinLeft($tableName, $targetTableName = null, $alias = null)
