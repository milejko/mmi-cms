 ...
 * @method QueryHelper\CmsCommentQueryJoin join($tableName, $targetTableName = null)
 * @method QueryHelper\CmsCommentQueryJoin joinLeft($tableName, $targetTableName = null)
