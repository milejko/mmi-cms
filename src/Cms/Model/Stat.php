...
class Stat {
	...
	public static function agregate() {
		...
		$processed = 0;
		foreach (Orm\Stat\Query::factory()->limit(10000)->find() as $item) {
			$processed++;
	...
	public static function getUniqueObjects() {
		$all = Orm\Stat\Date\Query::factory()
