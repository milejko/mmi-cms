			...
			editor.undoManager.transact(function() {
				...
				if (data.caption === false) {
					if (dom.is(imgElm.parentNode, 'figure.image')) {
                        ...
                        /* usuniecie atrybutow - powoduja problem z linkiem */
                        imgElm.removeAttribute('contenteditable');
                        imgElm.removeAttribute('caption');
                        imgElm.removeAttribute('data-fix');
                        /* */
				...
				if (data.caption === true) {
					if (!dom.is(imgElm.parentNode, 'figure.image')) {
                        ...
                        imgElm.setAttribute('contenteditable', true);
                        imgElm.setAttribute('data-fix', true);
                        
						imgElm = imgElm.cloneNode(true);
						figureElm = dom.create('figure', {'class': 'image caption'});
