...
var metoda_1 = LatexCmds.metoda_1 = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\^{}_{}';
  _.htmlTemplate =
      '<span class="fraction non-leaf">'
    +   '<span class="numerator">&0</span>'
    +   '<span class="denominator" style="border: none">&1</span>'
...
var Vec = LatexCmds.vec = P(MathCommand, function(_, _super) {
  ...
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="vector-prefix scaled">&rarr;</span>'
...
LatexCmds.left = bind(VanillaSymbol, '\\left ', '&#123;');
...
(function() {
  var trig = ['sin', 'cos', 'tan', 'sec', 'cosec', 'csc', 'cotan', 'cot', 'tg', 'ctg'];
  for (var i in trig) {
    LatexCmds[trig[i]] =
    LatexCmds[trig[i]+'h'] =
