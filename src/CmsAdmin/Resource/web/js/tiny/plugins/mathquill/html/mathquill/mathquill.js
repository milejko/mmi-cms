...
var Vech = LatexCmds.vech = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\vech';
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="vector-prefix">&rightharpoonup;</span>'
    +   '<span class="vector-stem">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['vech(', ')'];
...
var Veclr = LatexCmds.veclr = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\veclr';
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="vector-prefix">&longleftrightarrow;</span>'
    +   '<span class="vector-stem">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['vech(', ')'];
...
var ContentUpDown = LatexCmds.contentupdown = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\contentupdown';
  _.htmlTemplate =
      '<span class="content-block non-leaf">'
    +   '<sub class="content-up">&2</sub>'
    +   '<span class="content-main">&0</span>'
    +	'<sup class="content-down">&1</sup>'
    + '</span>'
  ;
  _.textTemplate = ['vec(', ')'];
});

var ContentUp = LatexCmds.contentup = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\contentup';
  _.htmlTemplate =
      '<span class="content-block non-leaf">'
    +   '<sub class="content-up">&1</sub>'
    +   '<span class="content-main">&0</span>'
    +	'<sup class="content-down">&#160</sup>'
    + '</span>'
  ;
  _.textTemplate = ['vec(', ')'];
});

var ContentDown = LatexCmds.contentdown = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\contentdown';
  _.htmlTemplate =
      '<span class="content-block non-leaf">'
    +   '<sub class="content-up">&#160</sub>'
    +   '<span class="content-main">&0</span>'
    +	'<sup class="content-down">&1</sup>'
    + '</span>'
  ;
...
LatexCmds.Chi =
LatexCmds.Omega =
LatexCmds.forall = P(Variable, function(_, _super) {
  _.init = function(latex) {
    _super.init.call(this,'\\'+latex+' ','&'+latex+';');
  };
});
...
//spacing
LatexCmds.space = LatexCmds.emsp = bind(VanillaSymbol,'\\quad ',' ');
...
LatexCmds.increment = LatexCmds.inc = bind(VanillaSymbol,'\\increment ','&#8710;');
