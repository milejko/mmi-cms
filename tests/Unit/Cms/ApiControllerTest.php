...
class ApiControllerTest extends TestCase
{
    ...
    public function testIfSampleSkinIsListedWithProperLinks(): void
    {
        ...
        self::assertEquals('application/json', $response->getType());
        self::assertEquals('{"scopes":[{"key":"sample","name":"Sample Skin","_links":[{"href":"\/api\/sample","rel":"config"},{"href":"\/api\/sample\/contents","rel":"contents"},{"href":"\/api\/sample\/structure","rel":"structure"}]}]}', $response->getContent());
    }
    ...
    public function testIfSampleConfigIsVisible(): void
    {
        ...
        self::assertEquals(200, $response->getCode());
        self::assertEquals('application/json', $response->getType());
        self::assertEquals('{"key":"sample","attributes":{"sample-attribute":"value"},"templates":["sampletpl","invalidsampletpl"],"_links":[{"href":"\/api\/sample\/contents","rel":"contents"},{"href":"\/api\/sample\/structure","rel":"structure"}]}', $response->getContent());
    }
